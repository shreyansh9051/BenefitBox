    ...
    <section class="text-gray-600 body-font relative">
        ...
        <div class="container px-5 py-24 mx-auto">
            ...
            <div class="flex flex-col text-center w-full mb-12">
                ...
                <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Create Combo Plan</h1>
    
                <p class="lg:w-2/3 mx-auto leading-relaxed text-base">Create a new combo plan</p>
    
            </div>
    
            <div class="lg:w-1/2 md:w-2/3 mx-auto">

                <form action="{{ route('combo-plans.store') }}" method="post">
                    ...
                    <div class="flex flex-wrap -m-2">
                                ...
                                <select class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300" id="plans" name="plans[]" class="..." multiple>
                                    ...
                                    @foreach ($plans as $id => $plan)
                                        ...
                                        <option value="{{ $id }}" 
                                            ...
                                            @selected(old('plans') && in_array($id, old('plans', [])))>
                        ...
                        <div class="p-2 w-full">
                            ...
                            <button class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">Create Combo Plan</button>
