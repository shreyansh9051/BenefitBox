    ...
    <section class="text-gray-600 body-font relative">
        ...
        <div class="container px-5 py-24 mx-auto">
            ...
            <div class="flex flex-col text-center w-full mb-12">
                ...
                <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Create Plan</h1>
    
                <p class="lg:w-2/3 mx-auto leading-relaxed text-base">Create a new plan</p>
                    ...
                    <div class="flex flex-wrap -m-2">
                        ...
                        <div class="p-2 w-1/2">
                            ...
                            <div class="relative">
                                ...
                                <input type="number" id="price" name="price" min="0" max="999" step="0.01" value="{{ old('price') }}"
                        ...
                        <div class="p-2 w-full">
                            ...
                            <button class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">Create Plan</button>
