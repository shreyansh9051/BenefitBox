    ...
    <section class="text-gray-600 body-font relative">
        ...
        <div class="container px-5 py-24 mx-auto">
            ...
            <div class="flex flex-col text-center w-full mb-12">
                ...
                <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Create Eligibility Criteria</h1>
    
                <p class="lg:w-2/3 mx-auto leading-relaxed text-base">Create a new eligibility criteria</p>
    
            </div>
    
            <div class="lg:w-1/2 md:w-2/3 mx-auto">

                <form action="{{ route('eligibility-criteria.store') }}" method="post">
                    ...
                    <div class="flex flex-wrap -m-2">
                        ...
                        <div class="p-2 w-1/2">
                            ...
                            <div class="relative">
                                ...
                                <input type="umber" min="0" max="100" step="1" id="age_less_than" name="age_less_than" value="{{ old('age_less_than') }}" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                        ...
                        <div class="p-2 w-1/2">
                            ...
                            <div class="relative">
                                ...
                                <input type="umber" min="0" max="100" step="1" id="age_greater_than" name="age_greater_than" value="{{ old('age_greater_than') }}" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                        ...
                        <div class="p-2 w-1/2">
                            ...
                            <div class="relative">
                                ...
                                <input type="umber" min="0" max="999" step="0.01" id="income_less_than" name="income_less_than" value="{{ old('income_less_than') }}" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                        ...
                        <div class="p-2 w-1/2">
                            ...
                            <div class="relative">
                                ...
                                <input type="umber" min="0" max="999" step="0.01" id="income_greater_than" name="income_greater_than" value="{{ old('income_greater_than') }}" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                            ...
                            <div class="relative">
                                ...
                                <select id="status" name="status" class="w-20 bg-gray-100 bg-opacity-50 rounded border border-gray-300">
                                    ...
                                    @foreach (App\Enums\EligibilityCriteriaStatus::cases() as $status)
                                        ...
                                        <option value="{{ $status->value }}" >{{ Str::ucfirst(Str::lower($status->name)) }}</option>
